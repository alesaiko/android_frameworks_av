...
status_t OMXNodeInstance::emptyBuffer(
    ...
    // Convert incoming ANW meta buffers if component is configured
    // for Gralloc metadata mode.  Ignore rangeOffset in this case.
    if (mMetadataType[kPortIndexInput] == kMetadataBufferTypeGrallocSource
        ...
        CLOG_BUFFER(emptyBuffer, "Converting ANWB %p to handle %p",
                    backupMeta.pBuffer, backupMeta.pBuffer ?
                    backupMeta.pBuffer->handle : nullptr);

        codecMeta.pHandle = backupMeta.pBuffer ? backupMeta.pBuffer->handle : nullptr;
