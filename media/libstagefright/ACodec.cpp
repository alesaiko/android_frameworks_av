...
#ifdef CAMCORDER_GRALLOC_SOURCE
        // For this specific case we could be using camera source even if
        // storeMetaDataInBuffers returns Gralloc source. Pretend that we are.
        // This will force us to use nBufferSize.
